...
class Button_n:
    def __init__(self, text, color, x, y, font, screen, h, w):
        # height  # высота
        # width   ширина
        self.width = w
        self.height = h
        ...
        if x < mouse[0] < x + self.width and y < mouse[1] < y + self.height:
            ...
            if click[0] == 1 and y == 200:
                ...
                while True:
                    ...
                    if 100 < mouse[0] < 100 + 300 and 100 < mouse[1] < 100 + 300:
                        pygame.draw.rect(screen, (21, 20, 24), (100 - 10, 100, 300, 300))
...
def castomize():
    ...
    while True:
        Surphase(windowSurface)
        Button('Нажмите esc для возвращения в главное меню', (255, 255, 255), 0, 0, 40, windowSurface)
        Button_n('Кастомизировать корабль', (255, 255, 255), 400, 200, 40, windowSurface, 60, 415)
        Button_n('Кастомизировать метеориты', (255, 255, 255), 400, 300, 40, windowSurface, 60, 460)
        Button_n('Кастомизировать задний фон', (255, 255, 255), 400, 400, 40, windowSurface, 60, 470)
        pygame.display.update()
        for event in pygame.event.get():
            if event.type == QUIT:
                terminate()
